		...
		if($settings['type'] == 'text') {
			...
			foreach ($ds_input_setting_option as $option){
				if(!($multifield_text_counter > 1 && $option == '')) {
					echo '<div class="ds-wp-api-expanding-input"><input type="text" id="' . $settings['id'] . '_' . $option . '" name="' . $option_name . '[' . $settings['id'] . '][]" value="'. $option . '" class="ds-wp-api-input ' . $ds_input_class .'" /><span class="ds-wp-api-expanding-input-remove"></span></div>';
			...
			foreach ($settings['options'] as $option_value => $option_text) {
				...
				echo '<input type="checkbox" name="' . $option_name . '[' . $settings['id'] . '][]" id="' . $settings['id'] . '_' . $option_value . '" value="' . $option_value . '" ' . $checked . '/>';
